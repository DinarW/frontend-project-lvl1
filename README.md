...
Команда для запуска: _brain-even_
...
Команда для запуска: _brain-prime_
...
Команда для запуска: _brain-progression_
